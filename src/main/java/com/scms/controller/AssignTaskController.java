...
public class AssignTaskController {
    ...
    private void onConfirm() {
        ...
        Double qty = InputSanitizer.parseDoubleOrNull(qtxt.trim());
        if (qty == null) { showAlert(Alert.AlertType.WARNING, "Validacija", "Količina mora biti broj."); return; }
        ...
        t.setUnit(InputSanitizer.sanitizeText(unitField.getText()));
