        ...
        dialog.setResultConverter(btn -> {
            if (btn == save) {
                try {
                    ...
                    if (qty == null) throw new IllegalArgumentException("Količina mora biti broj");
                    Double up = null;
                    if (unitPriceField.getText() != null && !unitPriceField.getText().isBlank()) up = InputSanitizer.parseDoubleOrNull(unitPriceField.getText());
