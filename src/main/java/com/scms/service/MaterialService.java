...
public class MaterialService {
    ...
    public Material createMaterial(Material m) {
        ...
        try {
            ...
            // NOTE: previously the service recorded an automatic InventoryMovement (type=IN)
            // when a material was created with a purchase price and quantity. That caused
            // deliveries to be added automatically when adding items into the storage UI.
            // Deliveries (inventory movements) should be created manually by the user via
            // the Deliveries UI. Therefore we intentionally do NOT create any movement here.
